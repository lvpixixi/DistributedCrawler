...
public final class FTPUtils {
    ...
    * @throws IOException
    */
   public void upLoadByFtp(byte[] data, String destDir,
...
//       absDstDir = absDstDir.replaceAll("//", "/");
       makeDirectory(ftp,destDir.replace("\\", "/"));
      ...
      // System.out.println("h************" + ftp.printWorkingDirectory() + "*******");
       ...
       this.ftp.setDataTimeout(60000);       //设置传输超时时间为60秒 
       this.ftp.setConnectTimeout(60000);       //连接超时为60秒
       ...
       this.ftp.setCopyStreamListener(new MyCopyStreamListener(data.length));
       //FTPFile[] files = this.ftp.listFiles(destFileName);
       uploadFile(destFileName, data, this.ftp);
   }
...
//        absDstDir = absDstDir.replaceAll("//", "/");
    ...
    * @throws IOException
    */
   private boolean uploadFile(String destFileName, byte[] data,
    ...
    public static void main(String[] args) throws IOException {
        ...
        //上传文件
        String absSrcFileName = "D:\\1.png";
        String destDir = "/image/";
        String destFileName = "j1.png";
        ...
        ftp.disconnect();
       /* // 下载文件
        String localFileName = "D:\\local.jpg";
        String remoteFileName = "image/j1.jpg";
        ftp.connect(hostname, port, username, password);
