...
public class FtpClientUtils {
    ...
    public static void main(String[] args) throws FileNotFoundException {
    	File f = new File("C:\\Users\\Public\\Pictures\\Sample Pictures\\1.jpg");
    	FtpClientUtils.uploadFile("127.0.0.1", 8070, "admin", "CE639E895E75B2C8A47B68C3FAF582A6", "tmp", "1.jpg",  new FileInputStream(f) );
    }
}
