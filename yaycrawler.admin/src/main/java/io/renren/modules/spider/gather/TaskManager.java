...
public class TaskManager {
    ...
    private Logger TASK_LOG = LoggerFactory.getLogger("TASK_LOG");
     ...
     * @param taskId 任务id
     */
    public void stopTask1(String taskId) {
        //完毕更新任务状态信息
    ...
    public boolean findTaskById(String taskId) {
       Task task = taskMap.get(taskId);
       if(task==null){
    	   return false;
       }else{
    	   return task.getState() ==State.RUNNING;
       }
    }
