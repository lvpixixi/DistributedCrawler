 ...
 * @version 16/7/18
 */
public class SpiderInfoDaoImplDemo extends ESDao<SpiderInfo>{
   // private final static Logger LOG = LoggerFactory.getLogger(SpiderInfoDaoImpl.class);
    private final static String INDEX_NAME = "spiderinfo", TYPE_NAME = "spiderinfo";
    private static final Gson gson = new GsonBuilder().create();

    @Autowired
    public SpiderInfoDaoImplDemo(ESClient esClient) {
        super(esClient, INDEX_NAME, TYPE_NAME);
    }

    public SpiderInfoDaoImplDemo() {
    }
