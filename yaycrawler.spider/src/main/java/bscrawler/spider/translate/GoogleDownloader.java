 ...
 * @since 0.1.0
 */
public class GoogleDownloader extends AbstractDownloader {
    ...
    public Page download(Request request, Task task) {
        ...
        try {
            ...
            HttpUriRequest httpUriRequest = getHttpUriRequest(request, site, headers, proxyHost);//锟斤拷锟斤拷锟斤拷锟斤拷锟剿达拷锟斤拷
            httpResponse = getHttpClient(site, proxy).execute(httpUriRequest);//getHttpClient锟斤拷锟斤拷锟斤拷锟剿达拷锟斤拷锟斤拷证
            statusCode = httpResponse.getStatusLine().getStatusCode();
            
            System.out.println(statusCode + " <=============="+ request.getExtra("nameValuePair").toString() +"====================> " + System.currentTimeMillis());
