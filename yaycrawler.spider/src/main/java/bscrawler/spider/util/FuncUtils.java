...
public class FuncUtils{
   ...
   /* public static String getIpAddr(HttpServletRequest request)
     ...
     * @return
     */
    /*public static String getSign(String sign_src) {
    	
    	String sign = "";
    	ResourceBundle bundler = ResourceBundle.getBundle("PartnerContants");
    	if ("RSA".equals(bundler.getString("SIGN_TYPE"))) {
			sign = RSAUtil.sign(bundler.getString("TRADER_PRI_KEY"), sign_src);
	    } else {
	        sign_src += "&key=" + bundler.getString("MD5_KEY");
	        try {
